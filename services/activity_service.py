...
from schema.activity import ActivityCreate, ActivityUpdate, ActivityDelete
...
def delete_activity(activity_id: int, activity_tobe_deleted: ActivityDelete, db: db_dependency):
    return activity_repo.delete_activity(activity_id, activity_tobe_deleted, db)