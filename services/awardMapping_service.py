...
from schema.awardMapping import awardMappingCreate, AwardMappingUpdate, AwardMappingDelete
...
def delete_awardMapping(awardMapping_id: int, awardMapping_delete: AwardMappingDelete, db: db_dependency):
    return awardMapping_repo.delete_awardMapping(awardMapping_id, awardMapping_delete, db)