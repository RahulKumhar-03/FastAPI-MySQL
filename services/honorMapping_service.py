...
from schema.honorMapping import HonorMappingCreate, HonorMappingUpdate, HonorMappingDelete
...
def delete_honorMapping(honorMapping_id: int, honorMapping_delete: HonorMappingDelete, db: db_dependency):
    return honorMapping_repo.delete_honorMapping(honorMapping_id, honorMapping_delete, db)